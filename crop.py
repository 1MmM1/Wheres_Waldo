...
def main():
    ...
    stichTiles(rows, cols, waldoTiles) 
...
# Stiches the tiles back together in B&W, only leaving the specified waldoTiles in color. 
# Saves the final image as foundwaldo.jpg and deletes the temporary images.
def stichTiles(rows, cols, waldoTiles):
